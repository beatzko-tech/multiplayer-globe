...
[![Deploy to Cloudflare](https://deploy.workers.cloudflare.com/button)](https://deploy.workers.cloudflare.com/?url=https://github.com/cloudflare/templates/tree/main/multiplayer-globe)
...
```
npm create cloudflare@latest -- --template=cloudflare/templates/multiplayer-globe
```

A live public deployment of this template is available at [https://multiplayer-globe.templates.workers.dev](https://multiplayer-globe.templates.workers.dev)
